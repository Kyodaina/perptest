...
- **LLaVA** for visual + text marketing interpretation
...
backend/
  app/
    ...
    services/
      model_manager.py       # LLaVA/Whisper loading + precision configs
...
- Models are downloaded automatically into `models/llava` and `models/whisper` on first use.
- Processing modes:
